...
public class EditActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void checkMode(){
        Intent i = getIntent();
        mode = i.getIntExtra("mode",DiaryActivity.REQUEST_ADD);

        if(mode == DiaryActivity.REQUEST_EDIT){
            loadScheduleData();
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.submit_btn:
                if(mode == DiaryActivity.REQUEST_ADD){
                    inputDataProcessing();
                    Intent i = new Intent();
                ...
                else if(mode == DiaryActivity.REQUEST_EDIT){
                    inputDataProcessing();
                    Intent i = new Intent();
                    ArrayList<Schedule> schedules = new ArrayList<Schedule>();
                    schedules.add(schedule);
